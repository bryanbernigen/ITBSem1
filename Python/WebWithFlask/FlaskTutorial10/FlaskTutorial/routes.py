...
from FlaskTutorial.forms import RegistrationForm,LoginForm, UpdateAccountForm, PostForm, RequestResetForm
...
def send_reset_email(user):
    ...
    msg = Message('Permohonan Perbaharui Kata Sandi',
                  sender='bryanbernigen@gmail.com',
                  recipients=[user.email])
    msg.body = f'''Untuk memperbaharui kata sandi, klik link dibawah Ini:
{url_for('reset_token', token=token, _external=True)}

Jika Anda tidak melakukan pemohonan ini, mohon abaikan email ini dan  kata sandi tidak akan diubah.
'''
    mail.send(msg)
